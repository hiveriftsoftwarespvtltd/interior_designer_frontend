        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 relative">
          ...
          <div className="lg:pr-12">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex items-start gap-6">
                <div className="w-12 h-12 border border-[#C9A15D]/40 flex items-center justify-center text-[#C9A15D] flex-shrink-0">
                  <Phone size={18} strokeWidth={1.5} />
                </div>
                <div className="pt-1">
                  <p className="font-sans text-[11px] font-semibold text-[#e8e6e3] tracking-[0.15em] uppercase mb-1">PHONE</p>
                  <p className="font-sans text-[14px] text-[#b3b3b3]">+91 98765 43210</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="pt-1">
                  ...
                  <p className="font-sans text-[14px] text-[#b3b3b3]">info@infinityluxespaces.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="pt-1">
                  ...
                  <p className="font-sans text-[14px] text-[#b3b3b3]">New Delhi, India</p>
                </div>
              </div>
          ...
          <div className="lg:pl-12">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              />
              <button type="submit" className="bg-gradient-to-r from-[#D7AE5D] to-[#BE9648] hover:opacity-90 text-[#050505] text-xs font-semibold tracking-[0.1em] uppercase px-8 py-3 w-fit inline-flex items-center gap-2 transition-all mt-2">
      ...
      <div className="section-container py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-12">
          {contactFeatures.map((f, i) => (
            <div key={i} className={`flex flex-col items-center text-center ${i < 3 ? 'lg:border-r border-[#C9A15D]/20' : ''}`}>
              <div className="h-auto flex items-center justify-center -mb-2 z-10">
                <img src={f.icon} alt={f.line1} className="w-[110px] h-auto object-contain" />
              </div>
        ...
        <div className="bg-[#0a0a0a] flex flex-col justify-center px-6 lg:px-16 py-12 lg:py-16 gap-6">
          <div className="flex items-center gap-4 sm:gap-6">
            <div className="w-[45px] h-[45px] relative flex-shrink-0 flex items-center justify-center">
              <img src={buildingIcon} alt="Studio" className="absolute w-[135px] max-w-none object-contain" />
            </div>
            <div>
